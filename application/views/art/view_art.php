  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        <h1><?php echo $image[0]->description;?></h1>
		...
		<div class="row">
			<div class="col-md-5 col-md-offset-0">
				<?php $imgdata = array('alt' => '125x125', 'src' => $image[0]->url, 'class' => 'img-responsive');
					  echo anchor(base_url($image[0]->url), img($imgdata), array('class' => 'thumbnails')); ?>
			</div>
			<div class="col-md-3">
				Test
			</div>
